...
export function BillingStep({ formData, onUpdate }: BillingStepProps) {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h3 className="text-xl font-semibold text-white mb-6">💳 Contract & Billing</h3>
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-center justify-between p-4 bg-gray-800 rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                <Label className="text-gray-300 font-medium">Paperless Billing</Label>
                <p className="text-sm text-gray-500">Receive bills electronically</p>
              </div>
            </div>
            <Switch
              checked={formData.paperlessBilling}
              onCheckedChange={(checked) => onUpdate("paperlessBilling", checked)}
            />
          </div>
        </div>
